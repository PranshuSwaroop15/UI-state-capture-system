...
#     #     prompt=input("Enter task or exit >")

#     #     if len(prompt)<=3:
#     #         print("Please enter a clear prompt")
        
#     #     if prompt=="exit":
            
#     #     CLI.StoreInfo(prompt)
    
#     def StoreInfo(prompt):
#          #Make a folder with name format YYYYMMDD-HHMMSS-<short-uuid>
#         base_path=Path("/Users/spranshu/Desktop/Soft-Light/runs")
#         time=datetime.datetime.now()
#         unid=str(uuid.uuid4())
#         custom_dir=f"{time}-{unid[:8]}"

#         nested_path=base_path/custom_dir
#         nested_path.mkdir(parents=True, exist_ok=True)
#         print(nested_path)
#         #Storing the raw prompt in the prompt.txt
#         with open(os.path.join(nested_path, 'prompt.txt'), 'w') as fp:
...
#         file_handler = logging.FileHandler(f"{nested_path}/run.log", mode="w")
...
#     print("Hi I am your UI State Capture System. How can I help you!")
